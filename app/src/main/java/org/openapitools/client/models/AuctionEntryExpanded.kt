...
data class AuctionEntryExpanded (
    ...
    @Json(name = "platform")
    val platform: AuctionEntryExpanded.Platform? = null,
    ...
    val isMarkedFor: AuctionEntryExpanded.IsMarkedFor? = null,
