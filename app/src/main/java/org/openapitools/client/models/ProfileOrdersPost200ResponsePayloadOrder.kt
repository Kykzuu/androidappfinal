...
data class ProfileOrdersPost200ResponsePayloadOrder (
    ...
    val orderType: ProfileOrdersPost200ResponsePayloadOrder.OrderType? = null,

    @Json(name = "platform")
    val platform: ProfileOrdersPost200ResponsePayloadOrder.Platform? = null,
